...
- Gives Pi a stable in-launcher transcript with restored session messages, separate thinking/response/tool lanes, queued follow-ups, abort/clear-queue controls, and answerable extension prompts; authoritative final-message repair and response-limit continuation cues prevent a long reasoning turn from silently disappearing. External Terminal remains available for Pi's full TUI.
